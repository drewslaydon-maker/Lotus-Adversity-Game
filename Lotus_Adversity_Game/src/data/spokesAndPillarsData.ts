...
export const phaseDossiersData: PhaseDossier[] = [
  {
    ...
    deliverables: [
      {
        title: "12-Spoke Wheel Blueprint",
  ...
  {
    phase: "PHASE 1",
    codename: "Tactical Core",
    timeframe: "Q4 2026 - Q1 2027",
    status: "ACTIVE SPRINT",
    title: "Tactical Core & Combat Slice",
    subtitle: "Playable Battle Engine, Posture Dynamics, and First Dungeon Arena",
    validationGate: "Combat feels tense, deliberate, and rewarding. Encounters respect player intelligence with 0% random misses.",
...
export const spokesData: Spoke[] = [
  // --- Dominion I: Iron (War) - Under Alden ---
  {
    id: "spoke-1-bastion",
    ...
    category: "Combat",
    color: "#f59e0b",
    originalVirtue: "The sanctuary of patience. Heavy plate worn by guardians to absorb blows intended for the innocent, suffering strikes without returning malice.",
    ...
    consumes: ["Tempered Billets (Spoke 11 Smithing)", "Toughened Leather Laces (Spoke 9 Trapping)", "Granite Ballast (Spoke 10 Quarrying)"],
    ...
    connectedSpokes: ["spoke-2-edge", "spoke-3-stance", "spoke-11-smithing"]
  },
  {
    id: "spoke-2-edge",
    ...
    category: "Combat",
    color: "#ef4444",
    originalVirtue: "The surgical boundary. Honed steel held in scabbards as a deterrent, drawn only to cut clean threads of danger without unnecessary suffering.",
    ...
    connectedSpokes: ["spoke-1-bastion", "spoke-3-stance", "spoke-11-smithing"]
  },
  {
    id: "spoke-3-stance",
    name: "The Stance Spoke (Poise & Footwork)",
    number: 3,
    dominion: "Iron",
    category: "Combat",
    color: "#fbbf24",
    originalVirtue: "The balanced pivot. The calm footwork of the diplomat standing before screaming hosts, rooted in dignity, evading panic with steady breath.",
    ...
    consumes: ["Supple Greave Liners (Spoke 9 Trapping)", "Balance Gyros (Spoke 5 Inscription)", "Ration Stews (Spoke 6 Alchemy)"],
    ...
    connectedSpokes: ["spoke-1-bastion", "spoke-2-edge", "spoke-12-breath"]
  },

  // --- Dominion II: Ether (Mind) - Under Caelen ---
  {
    id: "spoke-4-sorcery",
    ...
    consumes: ["Refined Luminary Flux (Spoke 6 Alchemy)", "Chiseled Quartz Prisms (Spoke 10 Quarrying)", "Runed Vellum (Spoke 5 Inscription)"],
    ...
    connectedSpokes: ["spoke-5-inscription", "spoke-6-alchemy", "spoke-10-quarrying"]
  },
  {
    id: "spoke-5-inscription",
    ...
    consumes: ["Ground Mineral Pigments (Spoke 10 Quarrying)", "Gallnut Ink (Spoke 8 Forestry)", "Chiseled Slate Tablets (Spoke 12 Masonry)"],
    ...
    connectedSpokes: ["spoke-4-sorcery", "spoke-6-alchemy", "spoke-11-smithing"]
  },
  {
    id: "spoke-6-alchemy",
    ...
    consumes: ["Bile & Gland Reagents (Spoke 9 Trapping)", "Wild Herbs & Moss (Spoke 7 Cartography)", "Volcanic Ash (Spoke 10 Quarrying)"],
    ...
    connectedSpokes: ["spoke-4-sorcery", "spoke-10-quarrying", "spoke-11-smithing"]
  },

  // --- Dominion III: Frontier (Wilds) - Under Mera ---
  {
    id: "spoke-7-cartography",
    name: "Wayfinding & Cartography (Topography & Paths)",
    number: 7,
    dominion: "Frontier",
    category: "Survival",
    color: "#10b981",
    ...
    consumes: ["Cured Parchment (Spoke 9 Trapping)", "Charcoal Pencils (Spoke 8 Forestry)", "Lodestones (Spoke 10 Quarrying)"],
    ...
    connectedSpokes: ["spoke-8-forestry", "spoke-9-trapping", "spoke-10-quarrying"]
  },
  {
    id: "spoke-8-forestry",
    name: "Wild Forestry & Logging (Timber & Char)",
    number: 8,
    dominion: "Frontier",
    category: "Gathering",
    color: "#059669",
    ...
    consumes: ["Tempered Felling Axes (Spoke 11 Smithing)", "Hardened Pitch (Spoke 6 Alchemy)", "Hauling Harnesses (Spoke 9 Trapping)"],
    ...
    connectedSpokes: ["spoke-7-cartography", "spoke-9-trapping", "spoke-11-smithing"]
  },
  {
    id: "spoke-9-trapping",
    ...
    consumes: ["Tempered Wire Snares (Spoke 11 Smithing)", "Aromatic Baits (Spoke 6 Alchemy)", "Hollow Calling Horns (Spoke 8 Forestry)"],
    ...
    connectedSpokes: ["spoke-7-cartography", "spoke-8-forestry", "spoke-1-bastion"]
  },

  // --- Dominion IV: Earth (Labor) - Under Bram ---
  {
    id: "spoke-10-quarrying",
    name: "Geological Quarrying (Stone & Strata Extraction)",
    number: 10,
    dominion: "Earth",
    category: "Gathering",
    color: "#fb923c",
    ...
    consumes: ["Hardened Steel Picks (Spoke 11 Smithing)", "Splitting Wedges (Spoke 12 Masonry)", "Blasting Powder (Spoke 6 Alchemy)"],
    ...
    connectedSpokes: ["spoke-11-smithing", "spoke-12-masonry", "spoke-4-sorcery"]
  },
  {
    ...
    consumes: ["Raw Dark-Iron & Copper Ore (Spoke 10 Quarrying)", "Lump Charcoal (Spoke 8 Forestry)", "Purifying Flux (Spoke 6 Alchemy)"],
  ...
  },
  {
    ...
    consumes: ["Granite Slabs (Spoke 10 Quarrying)", "Quicklime Mortar (Spoke 6 Alchemy)", "Hardwood Scaffolding (Spoke 8 Forestry)"],
    ...
    connectedSpokes: ["spoke-10-quarrying", "spoke-11-smithing", "spoke-7-cartography"]
  },
  // --- Dominion V: Axis (Stillness) - Under Soran ---
  {
    id: "spoke-13-breath",
    name: "The Breath Spoke (Stamina)",
    number: 13,
    dominion: "Axis",
    category: "Stillness",
    color: "#a855f7",
    ...
    consumes: ["Lotus Incense (Spoke 6 Alchemy)", "Woven Meditation Mats (Spoke 9 Trapping)"],
  ...
  },
  {
    ...
    consumes: ["Purified Spring Water (Spoke 7 Wayfinding)", "Aetheric Salts (Spoke 4 Sorcery)"],
  ...
  },
  {
    ...
    consumes: ["Lightweight Linens (Spoke 9 Trapping)", "Balancing Weights (Spoke 11 Smithing)"],
